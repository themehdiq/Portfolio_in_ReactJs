...
function Portfolio() {
  const portfolio = [
    ...
    },
    {
      id: 1,
      src: htmltailwindjs,
      title: "Website using html tailwindcss and Js",
    ...
    },
    {
      id: 2,
      src: htmlcssjs,
      title: "Website using html css and Js",
      githubLink: "",
  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto my-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-7 gap-8 px-12 sm:px-0">
          {portfolio.map((item) => {
            return (
              <div
                key={item.id}
